...
class Template(BaseModel):
    ...
    # [
    #   {"name": "liver_length", "label": "Длина печени", "type": "number",
    #    "unit": "мм", "normal_min": 100, "normal_max": 150},
    #   {"name": "liver_contour", "label": "Контуры",
    #    "type": "select", "options": ["ровные", "неровные"]},
    # ]
