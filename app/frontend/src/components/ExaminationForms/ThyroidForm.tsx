            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateField("right_thickness", e.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("right_nodule_size", e.target.value)
                      }
                      className="h-9"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        updateField("right_nodule_contours", v)
                      }
                    >
                      <SelectTrigger className="h-9">
                        <SelectValue placeholder={t.select} />
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        updateField("right_nodule_structure", v)
                      }
                    >
                      <SelectTrigger className="h-9">
                        <SelectValue placeholder={t.select} />
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="с кальцинатами">
                          {t.withCalcifications}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
            ...
            <div className="grid grid-cols-4 md:grid-cols-8 gap-3">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateField("left_thickness", e.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("left_nodule_size", e.target.value)
                      }
                      className="h-9"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        updateField("left_nodule_contours", v)
                      }
                    >
                      <SelectTrigger className="h-9">
                        <SelectValue placeholder={t.select} />
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        updateField("left_nodule_structure", v)
                      }
                    >
                      <SelectTrigger className="h-9">
                        <SelectValue placeholder={t.select} />
            ...
            <div className="grid grid-cols-3 md:grid-cols-4 gap-3">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateField("isthmus_thickness", e.target.value)
                  }
                />
              </div>
