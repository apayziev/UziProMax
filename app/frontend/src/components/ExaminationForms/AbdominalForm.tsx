          ...
          <AccordionContent className="pt-4 space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.liver_edge || ""}
                  onValueChange={(v) => updateField("liver_edge", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.liver_capsule || ""}
                  onValueChange={(v) => updateField("liver_capsule", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="дифференцируется отчётливо">
                      {t.capsuleDiff}
                    </SelectItem>
                    <SelectItem value="утолщена">
                      {t.capsuleThickened}
                    </SelectItem>
                    <SelectItem value="не дифференцируется">
                      {t.capsuleNoDiff}
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.liver_sound || ""}
                  onValueChange={(v) => updateField("liver_sound", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="сохранена (хорошая)">
                      {t.soundGood}
                    </SelectItem>
                    <SelectItem value="снижена">{t.soundDecreased}</SelectItem>
                    <SelectItem value="резко снижена">
                      {t.soundSeverelyDecreased}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("liver_kvr_right", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      type="number"
                      placeholder="125-140"
                      value={data.liver_kkr_right || ""}
                      onChange={(e) =>
                        updateField("liver_kkr_right", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      type="number"
                      placeholder="до 125"
                      value={data.liver_pzr_right || ""}
                      onChange={(e) =>
                        updateField("liver_pzr_right", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("liver_kvr_left", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      type="number"
                      placeholder="до 60"
                      value={data.liver_pzr_left || ""}
                      onChange={(e) =>
                        updateField("liver_pzr_left", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      type="number"
                      placeholder="до 20"
                      value={data.liver_caudate || ""}
                      onChange={(e) =>
                        updateField("liver_caudate", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-2">
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="диффузно неоднородная">
                      {t.diffuseHeterogeneous}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="не повышенной эхогенности">
                      {t.normal}
                    </SelectItem>
                    <SelectItem value="повышенной эхогенности">
                      {t.increased}
                    </SelectItem>
                    <SelectItem value="сниженной эхогенности">
                      {t.decreased}
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.liver_focal || ""}
                  onValueChange={(v) => updateField("liver_focal", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.liver_vessels || ""}
                  onValueChange={(v) => updateField("liver_vessels", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="не обеднён, чётко визуализируется">
                      {t.notImpoverished}
                    </SelectItem>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-2 border-t">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.bile_ducts || ""}
                  onValueChange={(v) => updateField("bile_ducts", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
          ...
          <AccordionContent className="pt-4 space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  value={data.gallbladder_shape || ""}
                  onValueChange={(v) => updateField("gallbladder_shape", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder={t.inNeckArea}
                  value={data.gallbladder_bend || ""}
                  onChange={(e) =>
                    updateField("gallbladder_bend", e.target.value)
                  }
                  className="h-9"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateField("gallbladder_size", e.target.value)
                  }
                  className="h-9"
                />
              </div>
              <div className="space-y-2">
                ...
                <Select
                  value={data.gallbladder_enlarged || ""}
                  onValueChange={(v) => updateField("gallbladder_enlarged", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  value={data.gallbladder_wall_contour || ""}
                  onValueChange={(v) =>
                    updateField("gallbladder_wall_contour", v)
                  }
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateField("gallbladder_wall", e.target.value)
                  }
                  className="h-9"
                />
              </div>
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="гомогенное">
                      {t.homogeneousContent}
                    </SelectItem>
                    <SelectItem value="негомогенное">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.gallbladder_formations || ""}
                  onValueChange={(v) =>
                    updateField("gallbladder_formations", v)
                  }
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
          ...
          <AccordionContent className="pt-4 space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  value={data.pancreas_topography || ""}
                  onValueChange={(v) => updateField("pancreas_topography", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="расположена обычно">
                      {t.usualLocation}
                    </SelectItem>
              ...
              <div className="space-y-2">
                <Label className="text-xs">{t.shape}</Label>
                <Select
                  value={data.pancreas_shape || ""}
                  onValueChange={(v) => updateField("pancreas_shape", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                  <SelectContent>
                    ...
                    <SelectItem value="гантелевидная">
                      {t.dumbbellShaped}
                    </SelectItem>
                    <SelectItem value="колбасовидная">
                      {t.sausageShaped}
                    </SelectItem>
                  </SelectContent>
                </Select>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    updateField("pancreas_echostructure", v)
                  }
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
              ...
              <div className="space-y-2">
                <Label className="text-xs">{t.echogenicity}</Label>
                <Select
                  value={data.pancreas_echogenicity || ""}
                  onValueChange={(v) => updateField("pancreas_echogenicity", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="не повышена (средняя)">
                      {t.normal}
                    </SelectItem>
              ...
              <div className="space-y-2">
                <Label className="text-xs">{t.soundConduction}</Label>
                <Select
                  value={data.pancreas_sound || ""}
                  onValueChange={(v) => updateField("pancreas_sound", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
          ...
          <AccordionContent className="pt-4 space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => updateField("spleen_shape", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="обычная (серповидная)">
                      {t.crescentShape}
                    </SelectItem>
              ...
              <div className="space-y-2">
                <Label className="text-xs">{t.contours}</Label>
                <Select
                  value={data.spleen_contour || ""}
                  onValueChange={(v) => updateField("spleen_contour", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateField("spleen_size", e.target.value)}
                  className="h-9"
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="space-y-2">
                <Label className="text-xs">{t.echostructure}</Label>
                <Select
                  value={data.spleen_echostructure || ""}
                  onValueChange={(v) => updateField("spleen_echostructure", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                <Label className="text-xs">{t.echogenicity}</Label>
                <Select
                  value={data.spleen_echogenicity || ""}
                  onValueChange={(v) => updateField("spleen_echogenicity", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.spleen_vein_state || ""}
                  onValueChange={(v) => updateField("spleen_vein_state", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
          ...
          <AccordionContent className="pt-4 space-y-4">
              ...
              <div className="p-3 border rounded-lg bg-muted/20 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    ...
                    <Select
                      value={data.kidney_right_position || ""}
                      onValueChange={(v) =>
                        updateField("kidney_right_position", v)
                      }
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="на обычном месте">
                          {t.usualPlace}
                        </SelectItem>
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      value={data.kidney_right_mobility || ""}
                      onValueChange={(v) =>
                        updateField("kidney_right_mobility", v)
                      }
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      ...
                      <SelectContent>
                        <SelectItem value="сохранена">
                          {t.mobilityPreserved}
                        </SelectItem>
                        <SelectItem value="ограничена">
                          {t.mobilityLimited}
                        </SelectItem>
                        <SelectItem value="отсутствует">
                          {t.mobilityAbsent}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    ...
                    <Input
                      placeholder="100x50x45"
                      value={data.kidney_right_size || ""}
                      onChange={(e) =>
                        updateField("kidney_right_size", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("kidney_right_parenchyma", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    <Label className="text-xs">{t.contours}</Label>
                    <Select
                      value={data.kidney_right_contour || ""}
                      onValueChange={(v) =>
                        updateField("kidney_right_contour", v)
                      }
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      ...
                      <SelectContent>
                        <SelectItem value="ровный, чёткий">
                          {t.smooth}
                        </SelectItem>
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      value={data.kidney_right_echo || ""}
                      onValueChange={(v) => updateField("kidney_right_echo", v)}
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="однородная, эхогенность не повышена">
                          {t.parenchymaNormal}
                        </SelectItem>
                        <SelectItem value="повышенной эхогенности">
                          {t.parenchymaIncreased}
                        </SelectItem>
                        <SelectItem value="неоднородная">
                          {t.parenchymaHeterogeneous}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    ...
                    <Select
                      value={data.kidney_right_pcs || ""}
                      onValueChange={(v) => updateField("kidney_right_pcs", v)}
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="не расширена">
                          {t.pcsNotDilated}
                        </SelectItem>
                        <SelectItem value="расширена">
                          {t.pcsDilated}
                        </SelectItem>
                        <SelectItem value="деформирована">
                          {t.pcsDeformed}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  ...
                  <div className="space-y-1">
                    ...
                    <Input
                      placeholder="соли 2-3мм"
                      value={data.kidney_right_stones || ""}
                      onChange={(e) =>
                        updateField("kidney_right_stones", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
              ...
              <div className="p-3 border rounded-lg bg-muted/20 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    <Label className="text-xs">{t.position}</Label>
                    <Select
                      value={data.kidney_left_position || ""}
                      onValueChange={(v) =>
                        updateField("kidney_left_position", v)
                      }
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                  ...
                  <div className="space-y-1">
                    <Label className="text-xs">{t.mobility}</Label>
                    <Select
                      value={data.kidney_left_mobility || ""}
                      onValueChange={(v) =>
                        updateField("kidney_left_mobility", v)
                      }
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("kidney_left_size", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("kidney_left_parenchyma", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    <Label className="text-xs">{t.contours}</Label>
                    <Select
                      value={data.kidney_left_contour || ""}
                      onValueChange={(v) =>
                        updateField("kidney_left_contour", v)
                      }
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                  ...
                  <div className="space-y-1">
                    <Label className="text-xs">{t.parenchymaEcho}</Label>
                    <Select
                      value={data.kidney_left_echo || ""}
                      onValueChange={(v) => updateField("kidney_left_echo", v)}
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      </SelectTrigger>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    <Label className="text-xs">{t.pcs}</Label>
                    <Select
                      value={data.kidney_left_pcs || ""}
                      onValueChange={(v) => updateField("kidney_left_pcs", v)}
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      </SelectTrigger>
                  ...
                  <div className="space-y-1">
                    ...
                    <Input
                      placeholder="соли 2-3мм"
                      value={data.kidney_left_stones || ""}
                      onChange={(e) =>
                        updateField("kidney_left_stones", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
            ...
            <div className="space-y-2 pt-2 border-t">
              ...
              <Select
                ...
                onValueChange={(v) => updateField("free_fluid", v)}
              >
                <SelectTrigger className="h-9">
                  <SelectValue placeholder={t.select} />
                </SelectTrigger>
