  ...
  return {
    ...
    lengthWidthThickness:
      language === "ru"
        ...
        : "uzunligi x kengligi x qalinligi",
    ...
    diffuseHeterogeneous:
      language === "ru" ? "диффузно неоднородная" : "diffuz har xil",
    ...
    additionalInfo:
      language === "ru" ? "Дополнительные сведения" : "Qo'shimcha ma'lumotlar",
    ...
    insignificant:
      language === "ru" ? "незначительное количество" : "ozgina miqdorda",
    moderate: language === "ru" ? "умеренное количество" : "o'rtacha miqdorda",
    significant:
      language === "ru" ? "значительное количество" : "ko'p miqdorda",
  }
}
...
export function getGynecologyTranslations(language: Language) {
  ...
  return {
    ...
    // Hayz
    lastMenstruation:
      language === "ru" ? "День последней менструации" : "Oxirgi hayz kuni",
    mcPhase: language === "ru" ? "Фаза МЦ" : "Hayz sikli fazasi",
    dependsOnPhase:
      language === "ru" ? "зависит от фазы МЦ" : "hayz sikli fazasiga bog'liq",
    ...
    myometriumStructure:
      language === "ru" ? "Структура миометрия" : "Miometriy tuzilishi",
    ...
    sizeStructure:
      language === "ru" ? "размер, структура" : "o'lcham, tuzilishi",
    ...
    // Bachadon naychalari
    fallopianTubes:
      language === "ru" ? "Маточные трубы" : "Bachadon naychalari",

    // Maksimal follikul
    maxFollicle: language === "ru" ? "Макс. фолликул" : "Maks. follikula",
    dominantFollicle:
      language === "ru" ? "Доминантный фолликул" : "Dominant follikula",
    ...
    nodeEchogenicity:
      language === "ru" ? "Эхогенность узлов" : "Tugunlar exogenligi",
    ...
    cdkVascularization:
      language === "ru" ? "При ЦДК васкуляризация" : "CDC vaskulyarizatsiya",
    ...
    intramuralNode:
      language === "ru" ? "Интрамуральный узел" : "Intramural tugun",
    ...
    slightlyEnlarged:
      language === "ru" ? "незначительно увеличена" : "biroz kattalashgan",

    // Kista (O-RADS)
    ovarianMass:
      language === "ru" ? "ОБРАЗОВАНИЕ В ПРИДАТКАХ" : "TUXUMDON O'SMASI",
    oradsClassification:
      language === "ru" ? "Классификация O-RADS" : "O-RADS tasnifi",
    orads1: language === "ru" ? "O-RADS 1 - норма" : "O-RADS 1 - norma",
    orads2:
      language === "ru"
        ? "O-RADS 2 - почти наверняка доброкачественное"
        : "O-RADS 2 - deyarli aniq yaxshi sifatli",
    orads3:
      language === "ru"
        ? "O-RADS 3 - низкий риск злокачественности"
        : "O-RADS 3 - past risk",
    orads4:
      language === "ru"
        ? "O-RADS 4 - средний риск злокачественности"
        : "O-RADS 4 - o'rtacha risk",
    orads5:
      language === "ru"
        ? "O-RADS 5 - высокий риск злокачественности"
        : "O-RADS 5 - yuqori risk",
    ...
    withSolidComponent:
      language === "ru" ? "с солидным компонентом" : "qattiq komponentli",

    // Kista turlari
    cystType: language === "ru" ? "Тип кисты" : "Kista turi",
    follicularCyst:
      language === "ru" ? "Фолликулярная киста" : "Follikulyar kista",
    corpusLuteumCyst:
      language === "ru" ? "Киста желтого тела" : "Sariq tana kistasi",
    endometrioidCyst:
      language === "ru" ? "Эндометриоидная киста" : "Endometrioid kista",
    dermoidCyst: language === "ru" ? "Дермоидная киста" : "Dermoid kista",
    mucinousCystoma:
      language === "ru" ? "Муцинозная кистома" : "Mutsionoz kistoma",
    seromasCystoma: language === "ru" ? "Серозная кистома" : "Seroz kistoma",
    paraovarianCyst:
      language === "ru" ? "Параовариальная киста" : "Paraovariyal kista",
    multiChamber:
      language === "ru" ? "Многокамерная киста" : "Ko'p kamerali kista",
    ...
    wallEchogenicity:
      language === "ru" ? "Эхогенность стенки" : "Devor exogenligi",
    hyperechoicWall: language === "ru" ? "гиперэхогенная" : "giperexogen",
    isoechoicWall: language === "ru" ? "изоэхогенная" : "izoexogen",

    // Kista tarkibi
    contentHomogeneity:
      language === "ru" ? "Однородность содержимого" : "Tarkib bir xilligi",
    homogeneousContent: language === "ru" ? "однородное" : "bir xil",
    heterogeneousContent: language === "ru" ? "неоднородное" : "har xil",
    withLinearEchos:
      language === "ru"
        ? "с мелкими линейными эхоструктурами"
        : "mayda chiziqli exotuzilmalar bilan",
    withAcousticShadow:
      language === "ru" ? "с акустической тенью" : "akustik soya bilan",
    withBloodClots:
      language === "ru" ? "с кровоизлиянием" : "qon quyilishi bilan",
    withSolidPapillary:
      language === "ru"
        ? "с сосочковыми разрастаниями"
        : "so'rg'ichsimon o'simtalar bilan",
    withDisperseSuspension:
      language === "ru" ? "с дисперсной взвесью" : "dispersli aralashma bilan",

    // Lokalizatsiya
    cystLocalization:
      language === "ru" ? "Локализация кисты" : "Kista joylashuvi",
    medialPosition:
      language === "ru"
        ? "медиальное, позади матки"
        : "medial, bachadon orqasida",
    lateralPosition:
      language === "ru"
        ? "латеральное, сбоку от матки"
        : "lateral, bachadon yonida",
    fixedLocation:
      language === "ru"
        ? "фиксированная локализация"
        : "qotib qolgan joylashuv",

    // CDC va qon oqimi
    vascularization:
      language === "ru" ? "Васкуляризация (ЦДК)" : "Vaskulyarizatsiya (CDC)",
    peripheralFlow:
      language === "ru" ? "периферический кровоток" : "periferik qon oqimi",
    centralFlow:
      language === "ru" ? "центральный кровоток" : "markaziy qon oqimi",
    noFlow:
      language === "ru" ? "кровоток не определяется" : "qon oqimi aniqlanmaydi",
    singleColorSpots:
      language === "ru" ? "единичные цветовые пятна" : "yakka rangli dog'lar",
    richVascularization:
      language === "ru" ? "богатая васкуляризация" : "boy vaskulyarizatsiya",

    // Qo'shimcha belgilar
    adhesions: language === "ru" ? "Спайки" : "Bitishmalar",
    withAdhesions:
      language === "ru" ? "с признаками спаек" : "bitishmalar belgilari bilan",
    ...
    slightlyPainful:
      language === "ru" ? "незначительно болезненная" : "biroz og'riqli",
    painful: language === "ru" ? "болезненная" : "og'riqli",

    // O'ng/Chap kista
    rightOvaryCyst:
      language === "ru" ? "КИСТА ПРАВОГО ЯИЧНИКА" : "O'NG TUXUMDON KISTASI",
    leftOvaryCyst:
      language === "ru" ? "КИСТА ЛЕВОГО ЯИЧНИКА" : "CHAP TUXUMDON KISTASI",
    cystDescription: language === "ru" ? "Описание кисты" : "Kista tavsifi",
    cystDiagnosis:
      language === "ru" ? "Предварительный диагноз" : "Dastlabki tashxis",
  }
}
  ...
  return {
    ...
    lastMenstruation:
      language === "ru"
        ...
        : "Oxirgi hayz 1-kuni",
    gestationalAge:
      language === "ru" ? "Срок беременности" : "Homiladorlik muddati",
    weeks: language === "ru" ? "нед" : "haft",
    days: language === "ru" ? "дн" : "kun",
    edd:
      language === "ru"
        ? "Предполагаемая дата родов"
        : "Taxminiy tug'ilish sanasi",
    ...
    crlFull:
      language === "ru" ? "Копчико-теменной размер" : "Dum-tepa o'lchami",
    ...
    lateralVentricles:
      language === "ru" ? "Боковые желудочки" : "Yon qorinchalar",
    ...
    heart4ch:
      language === "ru" ? "4-камерный срез сердца" : "4-kamerali yurak kesimi",
    ...
    grade0:
      language === "ru" ? "0 степень (до 30 нед)" : "0 daraja (30 haftgacha)",
    grade1:
      language === "ru" ? "I степень (27-36 нед)" : "I daraja (27-36 haft)",
    grade2:
      language === "ru" ? "II степень (34-39 нед)" : "II daraja (34-39 haft)",
    grade3:
      language === "ru" ? "III степень (37-40 нед)" : "III daraja (37-40 haft)",
...
export function getAbdominalTranslations(language: Language) {
  ...
  return {
    ...
    soundConduction:
      language === "ru" ? "Звукопроводимость" : "Tovush o'tkazuvchanlik",
    focalChanges:
      language === "ru" ? "Очаговые изменения" : "O'choqli o'zgarishlar",
    ...
    usualLocation:
      language === "ru" ? "расположена обычно" : "odatiy joylashgan",
    ...
    crescentShape:
      language === "ru" ? "обычная (серповидная)" : "oddiy (o'roqsimon)",
    ...
    parenchymaEcho:
      language === "ru" ? "Эхогенность паренхимы" : "Parenxima exogenligi",
    parenchymaNormal:
      language === "ru"
        ? "однородная, эхогенность не повышена"
        : "bir xil, exogenlik oshgan emas",
    parenchymaIncreased:
      language === "ru" ? "повышенной эхогенности" : "exogenlik oshgan",
...
export function getBreastTranslations(language: Language) {
  ...
  return {
    ...
    linearMultifreq:
      language === "ru"
        ? "линейный мультичастотный"
        : "chiziqli ko'p chastotali",
    ...
    noPathology:
      language === "ru"
        ? "без УЗ-признаков патологии"
        : "patologiya belgilari yo'q",
    thickened: language === "ru" ? "утолщена" : "qalinlashgan",
    changed: language === "ru" ? "изменена" : "o'zgargan",
    tissueDiff:
      language === "ru" ? "Дифференциация тканей" : "To'qima farqlanishi",
    ...
    moderatelyExpressed:
      language === "ru" ? "выражена умеренно" : "o'rtacha ifodalangan",
    weaklyExpressed:
      language === "ru" ? "слабо выражена" : "kuchsiz ifodalangan",
    ...
    notDifferentiated:
      language === "ru" ? "не дифференцируются" : "farqlanmaydi",
    ...
    singleLayer:
      language === "ru"
        ? "единым пластом (возрастная норма)"
        : "yagona qatlam (yosh normasi)",
    ...
    tissueEchogenicity:
      language === "ru" ? "Эхогенность ткани" : "To'qima exogenligi",
    moderatelyIncreased:
      language === "ru" ? "умеренно повышена" : "o'rtacha oshgan",
    ...
    parenchymaDiff:
      language === "ru" ? "Дифференциация паренхимы" : "Parenxima farqlanishi",
    ductsVisualization:
      language === "ru" ? "Визуализация протоков" : "Yo'llar ko'rinishi",
    ...
    nippleNormal:
      language === "ru"
        ? "форма округлая, контур ровный, структура однородная"
        : "shakl yumaloq, kontur tekis, tuzilish bir xil",
    fatLayer: language === "ru" ? "Жировая клетчатка" : "Yog' qatlami",
    noFeatures: language === "ru" ? "без особенностей" : "xususiyatlarsiz",
    retronippleArea:
      language === "ru" ? "Позадисосковая область" : "So'rsak orqasi",
    vascularPattern: language === "ru" ? "Сосудистый рисунок" : "Tomir rasmi",
    ...
    retromammarySpace:
      language === "ru" ? "Ретромаммарное пространство" : "Retromammar soha",
    lesionDetails:
      language === "ru" ? "Детали образования" : "O'sma tafsilotlari",
    tissueComposition:
      language === "ru" ? "Состав паренхимы" : "Parenxima tarkibi",
    predominantlyGlandular:
      language === "ru"
        ? "преимущественно железистой ткани"
        : "asosan bez to'qimasi",
    mixedTissue: language === "ru" ? "смешанной ткани" : "aralash to'qima",
    predominantlyFatty:
      language === "ru"
        ? "преимущественно жировой ткани"
        : "asosan yog' to'qimasi",
    ...
    anechoicCyst:
      language === "ru" ? "анэхогенное (киста)" : "anexogen (kista)",
    moderatelyDiffuseIncreased:
      language === "ru"
        ? "умеренно диффузно повышена"
        : "o'rtacha diffuz oshgan",
    ...
    axillaryRight:
      language === "ru" ? "Подмышечные справа" : "O'ngdagi qo'ltiq osti",
    axillaryLeft:
      language === "ru" ? "Подмышечные слева" : "Chapdagi qo'ltiq osti",
    ...
    birads0:
      language === "ru"
        ? "BI-RADS 0 - требуется доп. обследование"
        : "BI-RADS 0 - qo'shimcha tekshiruv kerak",
    birads1: language === "ru" ? "BI-RADS 1 - норма" : "BI-RADS 1 - norma",
    birads2:
      language === "ru"
        ? "BI-RADS 2 - доброкачественные изменения"
        : "BI-RADS 2 - yaxshi sifatli o'zgarishlar",
    birads3:
      language === "ru"
        ? "BI-RADS 3 - вероятно доброкачественные"
        : "BI-RADS 3 - ehtimol yaxshi sifatli",
    birads4:
      language === "ru"
        ? "BI-RADS 4 - подозрение на злокачественность"
        : "BI-RADS 4 - yomon sifatli gumon",
    birads5:
      language === "ru"
        ? "BI-RADS 5 - высокая вероятность злокачественности"
        : "BI-RADS 5 - yomon sifatli ehtimoli yuqori",
    birads6:
      language === "ru"
        ? "BI-RADS 6 - подтвержденная злокачественность"
        : "BI-RADS 6 - tasdiqlangan yomon sifatli",
  }
}
...
export function getThyroidTranslations(language: Language) {
  ...
  return {
    ...
    rightNodule:
      language === "ru"
        ? "Узловое образование правой доли"
        : "O'ng bo'lak tugun o'smasi",
    leftNodule:
      language === "ru"
        ? "Узловое образование левой доли"
        : "Chap bo'lak tugun o'smasi",

    // Umumiy hajm
    totalVolumeLymph:
      language === "ru"
        ? "ОБЩИЙ ОБЪЕМ И ЛИМФОУЗЛЫ"
        : "UMUMIY HAJM VA LIMFA TUGUNLARI",
    totalThyroidVolume:
      language === "ru" ? "Общий объем ЩЖ" : "QBning umumiy hajmi",
    normFemale:
      language === "ru"
        ? "норма: жен 9-18, муж 9-25"
        : "norma: ayol 9-18, erkak 9-25",

    // TI-RADS
    tirads: language === "ru" ? "КЛАССИФИКАЦИЯ TI-RADS" : "TI-RADS TASNIFI",
    tiradsIfNodules:
      language === "ru"
        ? "TI-RADS (если есть узлы)"
        : "TI-RADS (tugunlar bo'lsa)",
    tirads1: language === "ru" ? "TI-RADS 1 - норма" : "TI-RADS 1 - norma",
    tirads2:
      language === "ru"
        ? "TI-RADS 2 - доброкачественное"
        : "TI-RADS 2 - yaxshi sifatli",
    tirads3:
      language === "ru"
        ? "TI-RADS 3 - вероятно доброкачественное"
        : "TI-RADS 3 - ehtimol yaxshi sifatli",
    tirads4a:
      language === "ru" ? "TI-RADS 4a - низкий риск" : "TI-RADS 4a - past xavf",
    tirads4b:
      language === "ru"
        ? "TI-RADS 4b - умеренный риск"
        : "TI-RADS 4b - o'rtacha xavf",
    tirads4c:
      language === "ru"
        ? "TI-RADS 4c - высокий риск"
        : "TI-RADS 4c - yuqori xavf",
    tirads5:
      language === "ru"
        ? "TI-RADS 5 - злокачественное"
        : "TI-RADS 5 - yomon sifatli",
  }
}
