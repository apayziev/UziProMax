      ...
      <div className="p-4 border rounded-lg bg-muted/30">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="space-y-2">
            ...
            <Input
              type="date"
              value={data.pmc_date || ""}
              onChange={(e) => updateField("pmc_date", e.target.value)}
              className="h-9"
            />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={data.sensor || ""}
              onValueChange={(v) => updateField("sensor", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="линейный мультичастотный">
                  {t.linearMultifreq}
                </SelectItem>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-3 pt-3 border-t">
          <div className="space-y-2">
            ...
            <Select
              value={data.symmetry || ""}
              onValueChange={(v) => updateField("symmetry", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={data.skin || ""}
              onValueChange={(v) => updateField("skin", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="без УЗ-признаков патологии">
                  {t.noPathology}
                </SelectItem>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={data.tissue_diff || ""}
              onValueChange={(v) => updateField("tissue_diff", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
              <SelectContent>
                ...
                <SelectItem value="удовлетворительная">
                  {t.satisfactory}
                </SelectItem>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={data.fat_tissue || ""}
              onValueChange={(v) => updateField("fat_tissue", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="выражена умеренно">
                  {t.moderatelyExpressed}
                </SelectItem>
                <SelectItem value="слабо выражена">
                  {t.weaklyExpressed}
                </SelectItem>
                <SelectItem value="хорошо выражена">
                  {t.wellExpressed}
                </SelectItem>
              </SelectContent>
            </Select>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-3">
          <div className="space-y-2">
            ...
            <Select
              value={data.cooper_ligaments || ""}
              onValueChange={(v) => updateField("cooper_ligaments", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="дифференцируются">
                  {t.differentiated}
                </SelectItem>
                <SelectItem value="не дифференцируются">
                  {t.notDifferentiated}
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={data.nipple_areola || ""}
              onValueChange={(v) => updateField("nipple_areola", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
      ...
      <div className="p-4 border rounded-lg bg-blue-50/30">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="space-y-2">
            ...
            <Select
              value={data.tissue_type || ""}
              onValueChange={(v) => updateField("tissue_type", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="единым пластом (возрастная норма)">
                  {t.singleLayer}
                </SelectItem>
                <SelectItem value="железистый тип">
                  {t.glandularType}
                </SelectItem>
          ...
          <div className="space-y-2">
            <Label className="text-xs">
              {t.thicknessRight} ({t.mm})
            </Label>
            <Input
              type="number"
              step="0.1"
              placeholder="15.7"
              value={data.gland_thickness_right || ""}
              onChange={(e) =>
                updateField("gland_thickness_right", e.target.value)
              }
              className="h-9"
            />
          </div>
          <div className="space-y-2">
            <Label className="text-xs">
              {t.thicknessLeft} ({t.mm})
            </Label>
            <Input
              type="number"
              step="0.1"
              placeholder="15.5"
              value={data.gland_thickness_left || ""}
              onChange={(e) =>
                updateField("gland_thickness_left", e.target.value)
              }
              className="h-9"
            />
          </div>
          <div className="space-y-2">
            ...
            <Select
              value={data.tissue_echogenicity || ""}
              onValueChange={(v) => updateField("tissue_echogenicity", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
              <SelectContent>
                ...
                <SelectItem value="умеренно повышена">
                  {t.moderatelyIncreased}
                </SelectItem>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-3 pt-3 border-t">
          <div className="space-y-2">
            ...
            <Select
              value={data.milk_ducts || ""}
              onValueChange={(v) => updateField("milk_ducts", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              step="0.1"
              placeholder="1.6"
              value={data.duct_diameter || ""}
              onChange={(e) => updateField("duct_diameter", e.target.value)}
              className="h-9"
            />
          </div>
          <div className="space-y-2">
            ...
            <Select
              value={data.duct_walls || ""}
              onValueChange={(v) => updateField("duct_walls", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={data.duct_system || ""}
              onValueChange={(v) => updateField("duct_system", v)}
            >
              <SelectTrigger className="h-9">
                <SelectValue placeholder={t.select} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="соответствует возрастной норме">
                  {t.ageAppropriate}
                </SelectItem>
                <SelectItem value="не соответствует">
                  {t.notAgeAppropriate}
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <AccordionContent className="pt-4 space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  value={data.right_parenchyma_diff || ""}
                  onValueChange={(v) => updateField("right_parenchyma_diff", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="обычная">{t.normal}</SelectItem>
                    <SelectItem value="умеренно диффузно повышена">
                      {t.moderatelyDiffuseIncreased}
                    </SelectItem>
                    <SelectItem value="повышена">{t.increased}</SelectItem>
                    <SelectItem value="понижена">{t.decreased}</SelectItem>
                  </SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.right_ducts_phase || ""}
                  onValueChange={(v) => updateField("right_ducts_phase", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  value={data.right_nipple || ""}
                  onValueChange={(v) => updateField("right_nipple", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="форма округлая, контур ровный, структура однородная">
                      {t.nippleNormal}
                    </SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.right_fat_layer || ""}
                  onValueChange={(v) => updateField("right_fat_layer", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="без особенностей">
                      {t.noFeatures}
                    </SelectItem>
                    <SelectItem value="изменена">{t.changed}</SelectItem>
                  </SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.right_retronipple || ""}
                  onValueChange={(v) => updateField("right_retronipple", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.right_vascular || ""}
                  onValueChange={(v) => updateField("right_vascular", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="не усилен">
                      {t.notIntensified}
                    </SelectItem>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  value={data.right_focal || ""}
                  onValueChange={(v) => updateField("right_focal", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.right_retromammary || ""}
                  onValueChange={(v) => updateField("right_retromammary", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="p-3 border rounded-lg bg-red-50/50 space-y-3">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div className="space-y-2">
                    ...
                    <Input
                      placeholder={t.atOclock}
                      value={data.right_lesion_location || ""}
                      onChange={(e) =>
                        updateField("right_lesion_location", e.target.value)
                      }
                      className="h-9"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("right_lesion_size", e.target.value)
                      }
                      className="h-9"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="гипоэхогенное">
                          {t.hypoechoic}
                        </SelectItem>
                        <SelectItem value="изоэхогенное">
                          {t.isoechoic}
                        </SelectItem>
                        <SelectItem value="гиперэхогенное">
                          {t.hyperechoic}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      value={data.right_lesion_contours || ""}
                      onValueChange={(v) =>
                        updateField("right_lesion_contours", v)
                      }
                    >
                      <SelectTrigger className="h-9">
                        <SelectValue placeholder={t.select} />
          ...
          <AccordionContent className="pt-4 space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="space-y-2">
                <Label className="text-xs">{t.parenchymaDiff}</Label>
                <Select
                  value={data.left_parenchyma_diff || ""}
                  onValueChange={(v) => updateField("left_parenchyma_diff", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.left_tissue_type || ""}
                  onValueChange={(v) => updateField("left_tissue_type", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="преимущественно железистой ткани">
                      {t.predominantlyGlandular}
                    </SelectItem>
                    <SelectItem value="смешанной ткани">
                      {t.mixedTissue}
                    </SelectItem>
                    <SelectItem value="преимущественно жировой ткани">
                      {t.predominantlyFatty}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="space-y-2">
                <Label className="text-xs">{t.ductsPhase}</Label>
                <Select
                  value={data.left_ducts_phase || ""}
                  onValueChange={(v) => updateField("left_ducts_phase", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                <Label className="text-xs">{t.retronippleArea}</Label>
                <Select
                  value={data.left_retronipple || ""}
                  onValueChange={(v) => updateField("left_retronipple", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                <Label className="text-xs">{t.focalChanges}</Label>
                <Select
                  value={data.left_focal || ""}
                  onValueChange={(v) => updateField("left_focal", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                <Label className="text-xs">{t.retromammarySpace}</Label>
                <Select
                  value={data.left_retromammary || ""}
                  onValueChange={(v) => updateField("left_retromammary", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("left_lesion_location", e.target.value)
                      }
                      className="h-9"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("left_lesion_size", e.target.value)
                      }
                      className="h-9"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs">{t.contours}</Label>
                    <Select
                      value={data.left_lesion_contours || ""}
                      onValueChange={(v) =>
                        updateField("left_lesion_contours", v)
                      }
                    >
                      <SelectTrigger className="h-9">
                        <SelectValue placeholder={t.select} />
          ...
          <AccordionContent className="pt-4 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="space-y-2">
                ...
                <Select
                  value={data.supraclavicular_ln || ""}
                  onValueChange={(v) => updateField("supraclavicular_ln", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.subclavicular_ln || ""}
                  onValueChange={(v) => updateField("subclavicular_ln", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={data.anterior_chest_ln || ""}
                  onValueChange={(v) => updateField("anterior_chest_ln", v)}
                >
                  <SelectTrigger className="h-9">
                    <SelectValue placeholder={t.select} />
                  </SelectTrigger>
              ...
              <div className="p-3 border rounded-lg bg-muted/20 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <Input
                      placeholder="15.8x5.8"
                      value={data.right_ln_size1 || ""}
                      onChange={(e) =>
                        updateField("right_ln_size1", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      placeholder="18.2x6.5"
                      value={data.right_ln_size2 || ""}
                      onChange={(e) =>
                        updateField("right_ln_size2", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Select
                      value={data.right_ln_shape || ""}
                      onValueChange={(v) => updateField("right_ln_shape", v)}
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      </SelectTrigger>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    ...
                    <Select
                      value={data.right_ln_contours || ""}
                      onValueChange={(v) => updateField("right_ln_contours", v)}
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      </SelectTrigger>
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      value={data.right_ln_echo || ""}
                      onValueChange={(v) => updateField("right_ln_echo", v)}
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      </SelectTrigger>
              ...
              <div className="p-3 border rounded-lg bg-muted/20 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <Input
                      placeholder="14.2x6.3"
                      value={data.left_ln_size1 || ""}
                      onChange={(e) =>
                        updateField("left_ln_size1", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      placeholder="16.8x5.7"
                      value={data.left_ln_size2 || ""}
                      onChange={(e) =>
                        updateField("left_ln_size2", e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
                  <div className="space-y-1">
                    <Label className="text-xs">{t.lnShape}</Label>
                    <Select
                      value={data.left_ln_shape || ""}
                      onValueChange={(v) => updateField("left_ln_shape", v)}
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      </SelectTrigger>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1">
                    <Label className="text-xs">{t.lnContours}</Label>
                    <Select
                      value={data.left_ln_contours || ""}
                      onValueChange={(v) => updateField("left_ln_contours", v)}
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      </SelectTrigger>
                  ...
                  <div className="space-y-1">
                    <Label className="text-xs">{t.lnEchogenicity}</Label>
                    <Select
                      value={data.left_ln_echo || ""}
                      onValueChange={(v) => updateField("left_ln_echo", v)}
                    >
                      <SelectTrigger className="h-8">
                        <SelectValue placeholder={t.select} />
                      </SelectTrigger>
